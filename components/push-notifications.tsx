...
export function PushNotifications() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 left-4 z-[40] max-w-[calc(100vw-32px)] rounded-2xl border border-white/20 bg-black px-4 py-3 text-center text-sm font-semibold text-white shadow-2xl transition hover:bg-white hover:text-black disabled:cursor-not-allowed disabled:opacity-50 sm:left-6 sm:max-w-none sm:px-5"

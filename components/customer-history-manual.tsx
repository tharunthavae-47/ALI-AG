...
const empty = { entry_date: today(), title: "", description: "", mileage: "", mechanic: "", parts: "", fluids: "", fluid_liters: "", vehicle_id: "" }
...
export function CustomerHistoryManual({ customers, vehicles }: Props) {
  ...
  const save = async () => {
    ...
    const r = await createCustomerHistory({ customer_id: customerId, vehicle_id: form.vehicle_id || null, entry_date: form.entry_date, title: form.title, description: form.description, mileage: form.mileage ? Number(form.mileage) : null, mechanic: form.mechanic || null, parts: form.parts || null, fluids: form.fluids || null, fluid_liters: form.fluid_liters ? Number(form.fluid_liters) : null })
    setSaving(false)

    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-background px-6">
        <div className="w-full max-w-md border border-border bg-card p-8 text-center">
          <div className="mb-6"><p className="font-display text-xs uppercase tracking-[0.3em] text-muted-foreground">MB-Performance</p><h1 className="mt-2 font-display text-3xl font-bold uppercase tracking-wide">Besitzerbereich</h1></div>
          <p className="text-sm leading-relaxed text-muted-foreground">Sie sind nicht angemeldet.<br />Bitte melden Sie sich an, um die Verwaltung zu öffnen.</p>
          <Link href="/auth/login" className="mt-8 flex w-full items-center justify-center bg-primary px-6 py-4 font-display text-sm font-bold uppercase tracking-widest text-primary-foreground">Zum Besitzer-Login</Link>

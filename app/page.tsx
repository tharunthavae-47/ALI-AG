...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section id="termin" className="border-t border-border px-[6%] py-24">
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            <p className="font-display text-sm uppercase tracking-[0.35em] text-muted-foreground">Online buchen</p>
            ...
            <p className="mx-auto mt-4 max-w-lg text-pretty leading-relaxed text-muted-foreground">
              Wählen Sie einen freien Termin und schildern Sie Ihr Anliegen. Wir bestätigen Ihre Anfrage
              schnellstmöglich.
            </p>
          </div>
          <div className="mt-12">
